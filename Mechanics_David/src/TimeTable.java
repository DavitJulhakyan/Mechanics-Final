...
public class TimeTable extends JFrame implements ActionListener {
    ...
    public TimeTable() {
        ...
        this.courses = new CourseArray(543, 28); // Initialize courses
    ...
    public void setTools() {
        ...
        this.field[0].setText("28");
        this.field[1].setText("543");
        this.field[2].setText("/home/ani/Desktop/Mechanics_David/src/car-f-92.stu");
    ...
    private void saveTimeslotsToLog(int[] timeslots, int shift, int iterationIndex) {
        try (PrintWriter writer = new PrintWriter(new BufferedWriter(new FileWriter("timeslots_log_carf.txt")))) {
    ...
    private void runExperiment() {
        ...
        try (PrintWriter log = new PrintWriter(new BufferedWriter(new FileWriter("log_carf.txt", true)))) {
